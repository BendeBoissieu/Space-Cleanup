...
class Spacecraft {
    constructor(){
        gltfloader.load("starship_light.gltf",
        ( gltf ) => {
...
class OldSatellite{
    constructor(){
        gltfloader.load("old_satellite.gltf",
        ( gltf ) => {
...
function init() {
    ...
    const materialNormalMap = new THREE.MeshPhongMaterial( {
        ...
        specular: 0x333333,
        shininess: 15,
        map: textureLoader.load( "images/textures/8k_earth_daymap.jpg" ),
        specularMap: textureLoader.load( "images/textures/8k_earth_specular_map.jpg" ),
        normalMap: textureLoader.load( "images/textures/8k_earth_normal_map.jpg" ),
    ...
    const materialClouds = new THREE.MeshLambertMaterial( {
        ...
        map: textureLoader.load( "images/textures/earth_clouds.png" ),
        transparent: true
    ...
    const materialMoon = new THREE.MeshPhongMaterial( {
    	...
    	map: textureLoader.load( "images/textures/moon/2k_moon_map.jpg" ),
        specularMap: textureLoader.load( "images/textures/moon/2k_bump.jpg" )
...
function isColliding(obj1, obj2){
    return (
      Math.abs(obj1.x - obj2.x) < 15 &&
      Math.abs(obj1.z - obj2.z) < 15
    )
  }
