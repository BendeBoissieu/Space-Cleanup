	...
	constructor( object, domElement ) {
		...
		this.keydown = function ( event ) {
			...
			switch ( event.code ) {
				...
				case 'KeyW': this.moveState.forward = 10; break;
				case 'KeyS': this.moveState.back = 5; break;
		...
		this.mousedown = function ( event ) {
			...
			if ( this.dragToLook ) {
				...
				switch ( event.button ) {
					...
					case 0: this.moveState.forward = 10; break;
					case 2: this.moveState.back = 10; break;
		...
		this.updateMovementVector = function () {
			...
			// const forward = ( this.moveState.forward || ( this.autoForward && ! this.moveState.back ) ) ? 10 : 0;
